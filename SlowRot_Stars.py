...
Description:
    ...
    This code solves the system of differential equations which results
    from the Hartle-Thorne formalism of slow rotation approximation for a
    stationary neutron star.
    ...
    density and the last one is the derivative of the energy density
    w.r.t the pressure.
    It can run a single star for a concrete value of the pressure
    in the centre of the star (NumStars = 1) or it can run the whole
    Mass-Radius curve (NumStars = 0).
...
# Extended TOV system of equation within the Hartle-Thorne formalism
def TOV_Rota(r, var):
